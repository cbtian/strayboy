package com.staryboy.staryboy.views.xtablayout;
...
import com.mw.mwapp.R;
import com.mw.mwapp.utils.DensityUtil;
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
               ...
               /* int maxWidth = mIndicatorRight - mIndicatorLeft;
                ...
                if (isHomeActivity){
                    canvas.drawBitmap(BitmapFactory.decodeResource(getResources(),R.mipmap.curson),mIndicatorLeft- DensityUtil.dip2px(getContext(),5.5f),getHeight() - mSelectedIndicatorHeight-DensityUtil.dip2px(getContext(),11),mSelectedIndicatorPaint);
                }else {
                    canvas.drawBitmap(BitmapFactory.decodeResource(getResources(),R.mipmap.curson_rectangle),mIndicatorLeft+ DensityUtil.dip2px(getContext(),6f),getHeight() - mSelectedIndicatorHeight-DensityUtil.dip2px(getContext(),5),mSelectedIndicatorPaint);
                }
...
//                        mIndicatorRight, getHeight(), mSelectedIndicatorPaint);
    ...
    public void setIsHomeActivity(boolean homeActivity){
