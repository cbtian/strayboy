package com.staryboy.staryboy.views;
...
/**
 * Created by tiancb on 2017/8/23.
 */
...
public class MdStyleProgress extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mStatus == Status.Loading) {
            ...
            progressPaint.setColor(Color.parseColor("#00BFA2"));
            ...
            progressPaint.setColor(Color.parseColor("#ff525d"));
            canvas.drawArc(new RectF(0, 0, mRadius * 2, mRadius * 2), startAngle, 360, false, progressPaint);
