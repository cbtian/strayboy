...
public class BottomBarLayout extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    private List<com.strayboy.strayboy.views.bottombar.BottomBarItem> mItemViews = new ArrayList<>();
    ...
    private void init() {
        ...
        for (int i = 0; i < mChildCount; i++) {
            if (getChildAt(i) instanceof com.strayboy.strayboy.views.bottombar.BottomBarItem) {
                com.strayboy.strayboy.views.bottombar.BottomBarItem bottomBarItem = (com.strayboy.strayboy.views.bottombar.BottomBarItem) getChildAt(i);
    ...
    public com.strayboy.strayboy.views.bottombar.BottomBarItem getBottomItem(int position){
    ...
    public interface OnItemSelectedListener {
        void onItemSelected(com.strayboy.strayboy.views.bottombar.BottomBarItem bottomBarItem, int previousPosition, int currentPosition);
    }
