package com.strayboy.strayboy.views.refreshview.demo.stickyListHeaders;
...
public class StickyListHeadersListView extends FrameLayout {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                mList.setScrollBarStyle(a
                        .getInt(R.styleable.StickyListHeadersListView_android_scrollbarStyle, 0));
    ...
    protected void onLayout(boolean changed, int left, int top, int right,
        ...
        // if (!canLayoutListener.listViewCanLayout())
        // return;
    ...
    private class WrapperListScrollListener implements OnScrollListener {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem,
            ...
            // if
            // (canLayoutListener!=null&&!canLayoutListener.listViewCanLayout())
            // return;
