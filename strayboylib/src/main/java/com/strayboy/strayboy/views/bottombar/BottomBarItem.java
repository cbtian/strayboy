package com.strayboy.strayboy.views.bottombar;
...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemTextSize, com.strayboy.strayboy.views.bottombar.UIUtils.sp2px(mContext, mTextSize));
        ...
        mMarginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemMarginTop, com.strayboy.strayboy.views.bottombar.UIUtils.dip2Px(mContext, mMarginTop));
        ...
        mUnreadTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_unreadTextSize, com.strayboy.strayboy.views.bottombar.UIUtils.sp2px(mContext, mUnreadTextSize));
        ...
        mMsgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_msgTextSize, com.strayboy.strayboy.views.bottombar.UIUtils.sp2px(mContext, mMsgTextSize));
     ...
     * 设置未读数
     *
     * @param unreadNum 小于等于{@link com.strayboy.strayboy.views.bottombar.BottomBarItem#unreadNumThreshold}则隐藏，
     *                  大于0小于{@link com.strayboy.strayboy.views.bottombar.BottomBarItem#unreadNumThreshold}则显示对应数字，
     *                  超过{@link com.strayboy.strayboy.views.bottombar.BottomBarItem#unreadNumThreshold}
     *                  显示{@link com.strayboy.strayboy.views.bottombar.BottomBarItem#unreadNumThreshold}+
     */
